using FormControls_MVC5.DAL;
using FormControls_MVC5.Models;
using System.Collections.Generic;
using System.Linq;
using System.Web.Mvc;

namespace FormControls_MVC5.Controllers
{
    public class HomeController : Controller
    {
        IFormRepository _fRepo;
        public HomeController()
        {
            _fRepo = new FormRepository(new FormsDbContext());
        }
